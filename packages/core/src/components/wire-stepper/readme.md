...
| `currentStep`      | `current-step`       | Active step index                         | `number`                     | `0`            |
...
| ------------- | ------------------- | --------------------- |
| `cancelled`   | Cancellation event  | `CustomEvent<void>`   |
| `finished`    | Flow finished event | `CustomEvent<void>`   |
| `stepChanged` | Step change event   | `CustomEvent<number>` |
