...
import type { JSX } from '@wireio/ui-library';



export const MyComponent = /*@__PURE__*/createReactComponent<JSX.MyComponent, HTMLMyComponentElement>('my-component');
export const WireButton = /*@__PURE__*/createReactComponent<JSX.WireButton, HTMLWireButtonElement>('wire-button');
...
export const WireToast = /*@__PURE__*/createReactComponent<JSX.WireToast, HTMLWireToastElement>('wire-toast');
